...
export default function Contact() {
  ...
  const phone = "995558294364"; // WhatsApp number
  ...
  // IntersectionObserver: detect if contact section is visible
  useEffect(() => {
      ...
      <div className="w-[90%] max-w-[1150px] mx-auto py-20 text-white">
        ...
        <div className="lg:flex align-start justify-start">
            ...
            <input
                ...
                className="w-full px-4 py-3 border-b border-[#e6371d] text-white focus:outline-none focus:border-[#ffffff]"
                required
            />
            <input
                type="email"
            ...
            <button
                type="submit"
                className="bg-[#242424] p3 w-[130px] h-[130px] rounded-full hover:scale-105 transition flex items-center justify-center gap-3"
                disabled={loading}
            >
                {loading ? (
                "Sending..."
